<?php
	...
	if($nama_studio=='' or $tarif_studio=='' or $fasilitas_studio=='' or $keterangan=='' or $lokasi_file_a==''){
		...
		<SCRIPT language=\"Javascript\"> 
			 ...
			 document.location.href = 'input_data_harga_record.php';
		</SCRIPT>";
	}
	else{
		copy($_FILES['foto_studio']['tmp_name'],"./foto_studio/".$_FILES['foto_studio']['name']); 
		mysql_query("insert into studio values(0,'$nama_studio','$tarif_studio','$fasilitas_studio','$keterangan','".$_FILES['foto_studio']['name']."','record')");
