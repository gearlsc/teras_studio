              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                    ...
                    <div class="form-panel" style="position:relative; top:-80px;">
                  	  <h4 class="mb"><i class="fa fa-tasks"></i> FORM INPUT DATA RECORD</h4>
                      <form class="form-horizontal style-form" method="POST" enctype="multipart/form-data" action="simpan_data_harga_record.php">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">NAMA RECORD</label>
                              <div class="col-sm-10">
                                  <input name="nama_studio" type="text" class="form-control">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">TARIF RECORD</label>
                              <div class="col-sm-4">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">FOTO RECORD</label>
                              <div class="col-sm-10">
