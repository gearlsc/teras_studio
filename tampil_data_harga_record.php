              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                    ...
                    <div class="col-md-12" style="position:relative; top:-80px;">
                      ...
                      <h4><i class="fa fa-tasks"></i> DATA RECORD</h4>
           					<?php
                              		include("koneksi.php");
                              ...
                              <div align="right" style="margin-right:10px">
                              	<a href="edit_data_harga_record.php?id_studio=<?php echo $ulang_data['id_studio']; ?>" title="EDIT"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                                <a href="hapus_data_harga_record.php?id_studio=<?php echo $ulang_data['id_studio']; ?>" title="HAPUS"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
                              </div>
