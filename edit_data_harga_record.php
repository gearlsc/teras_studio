              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                    ...
                    <div class="form-panel" style="position:relative; top:-80px;">
                  	  <h4 class="mb"><i class="fa fa-tasks"></i> FORM EDIT DATA RECORD</h4>
                      ...
                      ?>
                      <form class="form-horizontal style-form" method="POST" enctype="multipart/form-data" action="edit_data_harga_record2.php">
