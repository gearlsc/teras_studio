<?php
	...
	if(isset($nilai)){
		...
		header("Location:tampil_data_harga_studio.php");
		exit();
	}
	...
	echo "
		<script type=\"text/javascript\">
			...
			if (answer)
document.location.href='hapus_data_harga_studio.php?nilai=1&id_studio=$id_studio';
			else
			document.location.href='tampil_data_harga_studio.php';
