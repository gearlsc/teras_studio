...
<?php 
	extract($_GET);
    if(isset($id_studio)){
		$studio=mysql_query("select * from studio a,transaksi b, pelanggan c where a.id_studio='$id_studio' and a.id_studio=b.id_studio and c.id_pelanggan=b.id_pelanggan");
?>                    
