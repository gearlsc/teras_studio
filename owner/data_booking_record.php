              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                    ...
                    <div class="form-panel" style="position:relative; top:-80px;">
                  	  <h4 class="mb"><i class="fa fa-tasks"></i> DATA TRANSAKSI RECORDING</h4>
<?php 
	include("koneksi.php");
	$data=mysql_query("select * from studio where rental='record'");
	while($ulang_data=mysql_fetch_assoc($data)){
?>
                      <a href="data_booking_record.php?id_studio=<?php echo $ulang_data['id_studio']; ?>&nama_studio=<?php echo $ulang_data['nama_studio']; ?>"><i class="fa fa-clock-o"></i>&nbsp;<span class="badge bg-primary"><?php echo $ulang_data['nama_studio']; ?></span></a>&nbsp;&nbsp;&nbsp;
<?php } ?>
					<br /><br /><br>
