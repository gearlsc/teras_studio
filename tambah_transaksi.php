              ...
              <div class="row">
                  <div class="col-lg-9 main-chart">
                    ...
                    <div class="form-panel" style="position:relative; top:-80px;">
                  	  <h4 class="mb"><i class="fa fa-tasks"></i> FORM TRANSAKSI RENTAL STUDIO</h4>
                      
                            <a href="trans_rental_studio.php"><span class="badge bg-primary">Kembali</span></a><br><br>
<?php 
	include("koneksi.php");
	extract($_GET);
...
?>  
                <form class="form-horizontal style-form" action="kalkulasi_pembayaran.php" method="post">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Tanggal Rental</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Pilih Studio </label>
                        <div class="col-sm-8">
                         <select name="id_studio" class="form-control">
							...
							?>
                            <option value="<?php echo $ulang_data['id_studio']; ?>"><?php echo $ulang_data['nama_studio']; ?>&nbsp;&nbsp;( Rp. <?php echo $harga; ?>,-/Jam )</option>
                            <?php } ?>
                         </select>
                        </div> 
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Lama Rental</label>
                        <div class="col-sm-8">
