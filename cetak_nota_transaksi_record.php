		...
		if($dat==11 or $dat==22 or $dat==33){ 
			...
			if($uang_diterima<$t){
				...
				<SCRIPT language=\"Javascript\"> 
					 ...
					 document.location.href = 'trans_rental_record.php';
				</SCRIPT>";
				exit();
			}
		}
...
<body onLoad="printpage()" background="images/bag_cetak_nota.JPG" style="background-repeat:repeat-y; background-position:center">
              ...
              <table width="580" border="0" align="center">
                  ...
                  <tr>
                    <td width="84">&nbsp;</td>
                    <td width="149">Tanggal Record</td>
                    <td width="21"><div align="center">:</div></td>
                    <td width="408"><?php echo $ulang_data['tanggal_booking']; ?></td>
                </tr>
                  <tr>
                    <td width="84">&nbsp;</td>
                    <td width="149">Lama Jam Record</td>
                    <td width="21"><div align="center">:</div></td>
                    <td width="408"><?php echo $ulang_data['total_jam']; ?> Jam</td>
                </tr>
                 <tr>
                    <td width="84">&nbsp;</td>
                    <td width="149">Tarif Record</td>
                    <td width="21"><div align="center">:</div></td>
                    <td width="408"><?php echo "@ Rp.$harga,-/5 Jam"; ?></td>
                </tr>
                <tr>
                    <td width="84">&nbsp;</td>
                    <td width="149">Total Bayar</td>
                    <td width="21"><div align="center">:</div></td>
                    <td width="408"><?php echo "Rp.$harga,-"; ?></td>
                </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>Uang Diterima</td>
                  ...
                  <tr>
                    ...
                    <td>Kembalian</td>
                    <td><div align="center">:</div></td>
                    <td><?php $kembalian=$uang_diterima-$ulang_data[tarif_studio]; $kembali = number_format($kembalian, 0, ',', '.'); echo "Rp.$kembali,-"; ?></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
