<?php
	...
	$total_bayar=$total_jam*$arr_studio['tarif_studio'];
                  ...
                  <div class="col-lg-9 main-chart">
                    ...
                    <div class="form-panel" style="position:relative; top:-80px;">
                  	  <h4 class="mb"><i class="fa fa-tasks"></i> KALKULASI PEMBAYARAN</h4>
                            ...
                            <a href="tambah_transaksi.php?id_pelanggan=<?php echo $_SESSION['id_pelanggan']; ?>"><span class="badge bg-primary">Kembali</span></a><br><br>
<?php
                              		include("koneksi.php");
									extract($_POST);
            ...
            <tr>
                  ...
                  <tr>
                    <td width="37">&nbsp;</td>
                    <td width="160">Tanggal Rental</td>
                    <td width="37"><div align="center">:</div></td>
                    <td width="417"><?php echo $_SESSION['tanggal_booking']; ?></td>
                </tr>
                  <tr>
                    <td width="37">&nbsp;</td>
                    <td width="160">Lama Jam Rental</td>
                    <td width="37"><div align="center">:</div></td>
                    <td width="417"><?php echo $_SESSION['total_jam']; ?> Jam</td>
                </tr>
                 <tr>
                    <td width="37">&nbsp;</td>
                   <td width="160">Tarif Studio</td>
                   <td width="37"><div align="center">:</div></td>
                   <td width="417"><?php echo "@ Rp.$harga,-/Jam"; ?></td>
                </tr>
                <tr>
                    <td width="37">&nbsp;</td>
                  <td width="160">Total Bayar</td>
                  <td width="37"><div align="center">:</div></td>
                  <td width="417"><?php $total = number_format($_SESSION['total_bayar'], 0, ',', '.'); echo "Rp.$total,-"; ?></td>
                </tr>
                  <tr>
                    <td width="37">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td>No. Kedatangan</td>
                    <td><div align="center">:</div></td>
                    <td><b><?php $dat=$jumlah_datang+1; echo $dat; if($dat==11 or $dat==22 or $dat==33){ echo " - Rental Gratis 1 Jam"; } ?></b></td>
                  </tr>
                  <?php if($dat==11 or $dat==22 or $dat==33){ ?>
                  <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td>
                    	...
                    	<form name="form1" method="post" action="cetak_nota_transaksi.php" target="_blank">
